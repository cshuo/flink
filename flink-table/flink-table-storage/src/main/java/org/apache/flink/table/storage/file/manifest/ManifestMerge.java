...
public class ManifestMerge {
    ...
    public ManifestMerge(DynamicTable table) {
        this.table = table;
    }
    ...
    private ManifestFileMeta doMerge(
        ...
        for (ManifestFileMeta manifest : manifests) {
            for (ManifestEntry entry : table.filesOfManifest(manifest)) {
                switch (entry.kind()) {
                    case ADD:
        ...
        ManifestFileMeta newManifest = table.writeManifestFile(newFiles);
