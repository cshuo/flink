...
/** */
public class DynamicSplitState {

    private final DynamicSplit split;

    private long recordsToSkipAfterOffset;

    public DynamicSplitState(DynamicSplit split) {
        this.split = split;
    }

    public DynamicSplit getSplit() {
        return split;
    }
    ...
    public DynamicSplit toStoreSplit() {
        return new DynamicSplit(
                split.getPartition(),
                split.getBucketId(),
                split.getFiles(),
                recordsToSkipAfterOffset);
    }
}
